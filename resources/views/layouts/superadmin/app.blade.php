...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        submenuLinks.forEach(function (link) {
            ...
            if (activeURLs.includes(href) && currentURL.includes(href)) {
                link.classList.add("active");
                // Tampilkan collapse jika submenu aktif
                const collapseDiv = document.getElementById("ui-basic");
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const currentURL = window.location.href;
        const submenuLinks = document.querySelectorAll("#ui-basic2 .nav-link");
        ...
        submenuLinks.forEach(function (link) {
            ...
            if (activeURLs.includes(href) && currentURL.includes(href)) {
                link.classList.add("active");
                // Tampilkan collapse jika submenu aktif
                const collapseDiv = document.getElementById("ui-basic2");
                collapseDiv.classList.add("show");
            }
        });
    });
...
<script type="text/javascript">
     ...
     $('.show_confirm3').click(function(event) {
          ...
          event.preventDefault();
          swal({
              title: `Apakah anda yakin mengaktifkan user?`,
              text: "",
              icon: "warning",
              buttons: true,
              dangerMode: true,
...
<script>
	var editor = new FroalaEditor('#my-editor');		
      </script>	 -->
