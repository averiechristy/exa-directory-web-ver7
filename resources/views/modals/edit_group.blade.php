<!-- edit_group.blade.php -->
  <!-- Edit Group Modal-->
  <div class="modal fade" id="editgroup{{$folder->id}}" tabindex="-1" role="dialog" aria-labelledby="EditGrouprModalLabel{{$folder->id}}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EditGrouprModalLabel{{$folder->id}}">Edit Group</h5>
