            ...
            <div id="content" class="content">              
              <div class="card mt-5">
                  ...
                  <div class="card-body py-3">
                      <h4 class="card-title">Data User Read</h4>         
                      <form action="{{ route('adminuserread.export') }}" method="GET" id="exportForm">
        ...
        <input id="search" placeholder>
                ...
                @include('components.alert')
                    ...
                    <div class="table-responsive">
                      ...
                      <thead>
    <tr>
        <th style="font-size:14pt;">Nama File <i class="fa fa-sort"></i></th>
        <th  style="font-size:14pt;">Nama User<i class="fa fa-sort"></i></th>
        <th  style="font-size:14pt;">Tanggal Baca<i class="fa fa-sort"></i></th>
    </tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                        <td  style="font-size:12pt;">{{$data -> nama_file}} </td>
                        <td  style="font-size:12pt;">{{$data-> nama_user}}  </td>
                        <td  style="font-size:12pt;">{{$data-> created_at}} </td>
                        </tr>
