...
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#editgroup{{$subfolder->id}}">Edit Group</a>
  ...
  <div class="modal fade" id="addSubfolderModal{{$subfolder->id}}" tabindex="-1" role="dialog" aria-labelledby="addSubfolderModalLabel{{$subfolder->id}}" aria-hidden="true">  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
